...
1. Rozwiązanie jest przeznaczone do testowania na maszynach o różnych adresach z tego względu, że zgodnie z treścią zadania każdy program radio-proxy wysyła klientom wiadomości z tego samego portu. Aby uruchomić rozwiązanie na jednej maszynie należy
